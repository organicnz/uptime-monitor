      ...
      <Card className="border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/50">
        ...
        <CardContent className="text-sm space-y-2 text-blue-700 dark:text-blue-300">
          <p>
            ...
            on Telegram and create a new bot with <code>/newbot</code>
          </p>
          <p>
            <strong>2.</strong> Copy the bot token provided by BotFather
          </p>
          <p>
            <strong>3.</strong> Start a chat with your new bot or add it to a
            group
          </p>
          <p>
            <strong>4.</strong> Get your chat ID by sending a message and
            visiting:{" "}
